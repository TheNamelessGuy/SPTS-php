...
$c = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver([($this->targetDirs[3].'/vendor/sonata-project/user-bundle/src/Resources/config/doctrine') => 'Sonata\\UserBundle\\Entity', ($this->targetDirs[3].'/src/Application/Sonata/UserBundle/Resources/config/doctrine') => 'Application\\Sonata\\UserBundle\\Entity', ($this->targetDirs[3].'/src/Application/Sonata/ClassificationBundle/Resources/config/doctrine') => 'Application\\Sonata\\ClassificationBundle\\Entity', ($this->targetDirs[3].'/vendor/sonata-project/classification-bundle/src/Resources/config/doctrine') => 'Sonata\\ClassificationBundle\\Entity', ($this->targetDirs[3].'/vendor/sonata-project/media-bundle/src/Resources/config/doctrine') => 'Sonata\\MediaBundle\\Entity', ($this->targetDirs[3].'/src/Application/Sonata/MediaBundle/Resources/config/doctrine') => 'Application\\Sonata\\MediaBundle\\Entity', ($this->targetDirs[3].'/src/Application/Sonata/NewsBundle/Resources/config/doctrine') => 'Application\\Sonata\\NewsBundle\\Entity', ($this->targetDirs[3].'/vendor/sonata-project/news-bundle/src/Resources/config/doctrine') => 'Sonata\\NewsBundle\\Entity']);
...
$b->addDriver($c, 'Application\\Sonata\\NewsBundle\\Entity');
$b->addDriver($c, 'Sonata\\NewsBundle\\Entity');
...
$a->setEntityNamespaces(['SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'ApplicationSonataUserBundle' => 'Application\\Sonata\\UserBundle\\Entity', 'ApplicationSonataClassificationBundle' => 'Application\\Sonata\\ClassificationBundle\\Entity', 'SonataClassificationBundle' => 'Sonata\\ClassificationBundle\\Entity', 'SonataMediaBundle' => 'Sonata\\MediaBundle\\Entity', 'ApplicationSonataMediaBundle' => 'Application\\Sonata\\MediaBundle\\Entity', 'ApplicationSonataNewsBundle' => 'Application\\Sonata\\NewsBundle\\Entity', 'SonataNewsBundle' => 'Sonata\\NewsBundle\\Entity']);
