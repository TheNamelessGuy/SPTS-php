...
$a = new \Metadata\Driver\FileLocator(['Sonata\\BlockBundle' => ($this->targetDirs[3].'/vendor/sonata-project/block-bundle/src/Resources/config/serializer'), 'Sonata\\UserBundle' => ($this->targetDirs[3].'/vendor/sonata-project/user-bundle/src/Resources/config/serializer'), 'Application\\Sonata\\UserBundle' => ($this->targetDirs[3].'/src/Application/Sonata/UserBundle/Resources/config/serializer'), 'Sonata\\ClassificationBundle' => ($this->targetDirs[3].'/vendor/sonata-project/classification-bundle/src/Resources/config/serializer'), 'Application\\Sonata\\ClassificationBundle' => ($this->targetDirs[3].'/src/Application/Sonata/ClassificationBundle/Resources/config/serializer'), 'Sonata\\MediaBundle' => ($this->targetDirs[3].'/vendor/sonata-project/media-bundle/src/Resources/config/serializer'), 'Application\\Sonata\\MediaBundle' => ($this->targetDirs[3].'/src/Application/Sonata/MediaBundle/Resources/config/serializer'), 'Sonata\\NewsBundle' => ($this->targetDirs[3].'/vendor/sonata-project/news-bundle/src/Resources/config/serializer'), 'Application\\Sonata\\NewsBundle' => ($this->targetDirs[3].'/src/Application/Sonata/NewsBundle/Resources/config/serializer')]);
