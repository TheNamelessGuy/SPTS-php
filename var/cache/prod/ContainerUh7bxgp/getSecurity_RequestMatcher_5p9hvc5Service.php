...
// Returns the private 'security.request_matcher.5p9hvc5' shared service.
...
return $this->services['security.request_matcher.5p9hvc5'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|Images|js)/');
