...
$instance->addXmlMappings([0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/config/validation.xml'), 2 => ($this->targetDirs[3].'\\vendor\\sonata-project\\classification-bundle\\src/Resources/config/validation.xml'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\media-bundle\\src/Resources/config/validation.xml'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\news-bundle\\src/Resources/config/validation.xml')]);
