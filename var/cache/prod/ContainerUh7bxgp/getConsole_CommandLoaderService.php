...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(['console.command.about' => function () {
    ...
    $f = function (\Symfony\Bundle\SecurityBundle\Command\InitAclCommand $v) { return $v; }; return $f(${($_ = isset($this->services['security.command.init_acl']) ? $this->services['security.command.init_acl'] : $this->load('getSecurity_Command_InitAclService.php')) && false ?: '_'});
}, 'security.command.set_acl' => function () {
    $f = function (\Symfony\Bundle\SecurityBundle\Command\SetAclCommand $v) { return $v; }; return $f(${($_ = isset($this->services['security.command.set_acl']) ? $this->services['security.command.set_acl'] : $this->load('getSecurity_Command_SetAclService.php')) && false ?: '_'});
